          ...
          <AnimatePresence mode="wait">
            {activeTab === 'attempts' && (
              <motion.div 
                ...
                exit={{ opacity: 0, x: -20 }}
                className="flex items-center gap-1.5 sm:gap-2 flex-nowrap shrink-0"
              >
                <button 
        ...
        {previewAttempt && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-white rounded-3xl shadow-2xl w-full max-w-5xl xl:max-w-6xl overflow-hidden flex flex-col max-h-[96vh]"
            >
              ...
              <div className="p-4 md:p-8 overflow-y-auto flex flex-col items-center gap-6">
                <Certificate 
